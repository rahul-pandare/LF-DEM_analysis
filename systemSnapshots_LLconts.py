...
fig_save_path = '/media/Linux_1TB/City College Dropbox/Rahul Pandare/CUNY/research/bidisperse_project/figures/paper_figs/LL_perse_snaps/'
    ...
    for k in range(len(ar)):
        ...
        if os.path.exists(dataname):
            ...
            for frame in range(startFrame, endFrame):
                ...
                directory = f'{fig_save_path}phi_{phii}_ar_{ar[k]}_vr_{vr}_LLconts'
