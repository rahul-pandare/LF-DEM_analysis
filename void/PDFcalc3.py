...
# PDF parameters
dr  = 1.2 #0.75   # in unit length
off = 100 #100    # no. of timesteps to skip for steady state
sizePair = 'all'
    ...
    for j in range(len(phi)):
        ...
        for l in range (numRuns):
            ...
            if os.path.exists(dataname):
                ...
                gxy     = np.zeros((n_bins, n_bins)) # initializing the PDF array
                ...
                txtFile = open(f'{dataname}/PDF_{sizePair}_gxy22.txt', 'w')
