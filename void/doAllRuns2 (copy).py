# function script to find F_rig of systems specified below
# it uses pebble game to calculate rigid clusters
# user input: phi

# command to run in terminal: python -c "from doAllRuns2 import doAllRuns2; doAllRuns2(phi)"
